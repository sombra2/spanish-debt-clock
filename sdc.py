...
previous_quarter = datetime.datetime(2023, 3, 31) # the date in YYYYMMDD format (leading zeroes not allowed) corresponding to the last quarter the information is provided
previous_quarter_debt = 1535262 * 10**6 
previous_quarter_minus_one_debt = 1502501 * 10**6
previous_quarter_minus_two_debt = 1503760 * 10**6
