...
previous_quarter = datetime.datetime(2023, 9, 30) # the date in YYYYMMDD format (leading zeroes not allowed) corresponding to the last quarter the information is provided
previous_quarter_debt = 1577266 * 10**6 
previous_quarter_minus_one_debt = 1568743 * 10**6
previous_quarter_minus_two_debt = 1535385 * 10**6
